        ...
        <html:form action= "/IssueBook">
            <table border="1">
                <tbody>
                    <tr>
                        <td colspan="2">
                            <bean:write name="IssueBookForm" property="error" filter="false"/>
                            Title Page;</td>
                    </tr>
                    <tr>
                        <td>ISBN Number</td>
                    ...
                    <tr>
                        <td>AdminID</td>
                        <td><html:text property="adminID" /></td>
                    </tr>
                    ...
                    <tr>
                        <td>DueDate</td>                      
                        <td><html:text property="duedate" /><html:link href="javascript:showCal('Calendar2')">Select Date</html:link></td>
                    </tr>
