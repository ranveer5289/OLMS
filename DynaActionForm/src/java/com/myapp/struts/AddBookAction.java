...
Class.forName("com.mysql.jdbc.Driver");
        Connection con = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/olms","root","asd");
     ...
     // String insert = "select * from userinfo";
      ...
      //  insert = "insert into books values('title','author',ISBN)";
        //ResultSet result = statatment.updateQuery(insert);
           val =   statatment.executeUpdate("insert into books values ('"+title+"','"+author+"','"+ISBN+"','"+Publication+"','"+Edition+"','"+Category+"','"+Price+"')");
     ...
     System.out.println(author);
       con.close();
       if(title.equals("") || author.equals("")|| Publication.equals("") || Category.equals(""))
       {
